...
date <- seq(as.Date("2014/6/1"), as.Date("2015/8/19"), "day")
...
library(rvest)
  ...
  clean <- subset(master_list, record_min_temp_year<=2015 & record_min_temp_year >=1800)
  leftovers <- subset(master_list, !(record_min_temp_year<=2015 & record_min_temp_year >=1800))
